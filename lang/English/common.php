...
'BBCode error empty tag'            =>  'Empty [%s] tag is not allowed',
'BBCode error unwanted bbcode'      =>  '[%s] tag had invalid content; expected plain text',
'BBCode error invalid img'          =>  '[img] tag had invalid content; expected a valid URL',
'BBCode error invalid url'          =>  '[url] tag had invalid content; expected a valid URL or an [img] tag',
'BBCode error invalid email'        =>  '[email] tag had invalid content; expected a valid email address',
'BBCode error invalid id'           =>  '[%s] tag had invalid content; expected a positive integer',
'BBCode error empty attribute'		=>	'[%s] tag had an empty attribute section',
'BBCode error invalid attribute'    =>  '[%s] tag had an invalid attribute section',
'BBCode error invalid list attribute' => '[list] tag had an invalid attribute, only 1, a, and * are allowed',
'BBCode error tag not allowed'		=>	'You are not allowed to use [%s] tags',
'BBCode error nesting depth'        =>  'You have nested too many [%1$s] tags, the limit is %2$d',
